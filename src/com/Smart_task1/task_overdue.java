...
public class task_overdue extends Activity implements OnItemClickListener
	...
	public void onCreate(Bundle savedInstanceState)
	 {
			...
			Cursor c=dbHelper.gettask_overdue(sdate);
			showtask(c);
			displayResultList();  
	       }
	private void displayResultList() 
	{
	//display task in listview
		 
		TextView tView = new TextView(this);
        tView.setText("OverDue Task!!! ");
