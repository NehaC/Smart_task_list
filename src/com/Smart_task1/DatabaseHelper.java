...
public class DatabaseHelper extends SQLiteOpenHelper 
{
	...
	static final String dbName="my_dd1";
	...
	{	db.execSQL("CREATE TABLE "+calllistTable+" ("+callid+ " INTEGER PRIMARY KEY AUTOINCREMENT,"+colclname+ " TEXT)");
		db.execSQL("CREATE TABLE "+locationTable+" ("+collocid+ " INTEGER PRIMARY KEY AUTOINCREMENT,"+collocname+ " TEXT,"+collat+ " DOUBLE,"+collong+ " DOUBLE,"+collocflag+" INTEGER)");
